  ...
  head: () => ({
    meta: [
      { title: "Forge — AI study plans from any timetable" },
      {
        name: "description",
        content:
          "Forge turns screenshots, PDFs, and routines into personalized study plans students actually follow. The AI academic OS.",
      },
      { property: "og:title", content: "Forge — AI study plans from any timetable" },
      {
        property: "og:description",
        content: "Turn chaotic schedules into structured study systems with AI.",
      },
    ],
    links: [
