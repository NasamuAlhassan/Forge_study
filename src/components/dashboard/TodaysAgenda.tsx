      ...
      <div className="space-y-0.5">
        {today.length === 0 ? (
          <div
            ...
            style={{ border: "1px dashed color-mix(in oklch, var(--foreground) 10%, transparent)" }}
          >
          ...
          today.map((e) => {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "h-8 w-8 rounded-xl bg-gradient-to-br grid place-items-center shrink-0 mt-0.5",
                    s.color,
                  )}
                >
